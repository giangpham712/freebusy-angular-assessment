import { inject, ComponentFixture, TestBed, fakeAsync, flush } from '@angular/core/testing';
...
describe('calendarWeekView component', () => {
  ...
  it('should add a custom CSS class to events', () => {
    ...
    fixture.componentInstance.ngOnChanges({ viewDate: {}, events: {} });
    fixture.detectChanges();
    expect(fixture.nativeElement.querySelector('.cal-event-container').classList.contains('foo')).to.equal(true);
    fixture.destroy();
  });
  ...
  it('should resize the all day event by dragging from the right edge', () => {
    ...
    const handle = fixture.nativeElement.querySelector('.cal-resize-handle-after-end');
  ...
  it('should validate resizing all day events from the right end', () => {
    ...
    const validateEventTimesChanged = sinon.stub().onFirstCall().returns(true).onSecondCall().returns(false);
  ...
  it('should validate resizing all day events from the left end', () => {
    ...
    fixture.componentInstance.events = [
      {
        title: 'foo',
        start: moment(fixture.componentInstance.viewDate).add(4, 'hours').toDate(),
        end: moment(fixture.componentInstance.viewDate).add(6, 'hours').toDate(),
        resizable: {
          beforeStart: true,
        },
        allDay: true,
    ...
    const handle = fixture.nativeElement.querySelector('.cal-resize-handle-before-start');
    triggerDomEvent('mousedown', handle, {
      clientX: rect.left,
      clientY: rect.top,
      button: 0,
    ...
    expect(resizeEvent).to.deep.equal({
      type: 'resize',
      event: fixture.componentInstance.events[0],
      newStart: moment(fixture.componentInstance.events[0].start).subtract(1, 'day').toDate(),
    ...
    expect(validateEventTimesChanged.getCall(1).args[0]).to.deep.equal({
      type: 'resize',
      event: fixture.componentInstance.events[0],
      newStart: moment(fixture.componentInstance.events[0].start).subtract(2, 'day').toDate(),
      newEnd: moment(fixture.componentInstance.events[0].end).toDate(),
    });
  });
  ...
  it('should allow the all day event to be dragged and dropped', () => {
    ...
    fixture.componentInstance.eventTimesChanged.pipe(take(1)).subscribe(eventDropped);
    triggerDomEvent('mousedown', event, {
      clientX: eventPosition.left,
      clientY: eventPosition.top,
      button: 0,
  ...
  it('should allow external events to be dropped on the week view headers', () => {
    ...
    fixture.detectChanges();
    document.body.appendChild(fixture.nativeElement);
    const externalEventFixture = fixture.debugElement.query(By.directive(ExternalEventComponent));
  ...
  it('should allow the weekend days to be customised', () => {
    ...
    fixture.componentInstance.weekendDays = [DAYS_OF_WEEK.FRIDAY, DAYS_OF_WEEK.SATURDAY];
  ...
  it('should add a custom CSS class to headers via the beforeViewRender output', () => {
    const fixture: ComponentFixture<CalendarWeekViewComponent> = TestBed.createComponent(CalendarWeekViewComponent);
    fixture.componentInstance.viewDate = new Date('2016-06-27');
    fixture.componentInstance.beforeViewRender.pipe(take(1)).subscribe(({ header }) => {
  ...
  it('should log on invalid events', () => {
    ...
    const fixture: ComponentFixture<CalendarWeekViewComponent> = TestBed.createComponent(CalendarWeekViewComponent);
    fixture.componentInstance.events = [{ start: 1234, title: '', color: { primary: '', secondary: '' } }] as any;
  ...
  it('should only call the beforeViewRender output once when refreshing the view', () => {
    ...
    const subscription = fixture.componentInstance.beforeViewRender.subscribe(beforeViewRenderCalled);
    fixture.componentInstance.refresh.next(true);
  ...
  it('should expose the view period on the beforeViewRender output', () => {
    const fixture: ComponentFixture<CalendarWeekViewComponent> = TestBed.createComponent(CalendarWeekViewComponent);
    const beforeViewRenderCalled = sinon.spy();
    fixture.componentInstance.beforeViewRender.pipe(take(1)).subscribe(beforeViewRenderCalled);
    fixture.componentInstance.ngOnInit();
    fixture.componentInstance.viewDate = new Date('2016-06-27');
    fixture.componentInstance.ngOnChanges({ viewDate: {} });
  ...
  it('should add event actions to each event', () => {
    ...
    const actionSpy = fixture.componentInstance.events[0].actions[0].onClick as sinon.SinonSpy;
    expect(actionSpy.getCall(0).args[0].event).to.equal(fixture.componentInstance.events[0]);
    expect(actionSpy.getCall(0).args[0].sourceEvent instanceof MouseEvent).to.be.true;
  ...
  it('should make a 4 day week', () => {
    ...
    expect(fixture.nativeElement.querySelectorAll('.cal-time-events .cal-day-column').length).to.equal(4);
  });
  ...
  it('should resize a time event from the end to another day on the right', () => {
    ...
    fixture.componentInstance.events = [
      {
        start: moment(new Date('2018-07-29')).startOf('day').add(3, 'hours').toDate(),
        end: moment(new Date('2018-07-29')).startOf('day').add(18, 'hours').toDate(),
        title: 'foo',
        resizable: {
          afterEnd: true,
        },
    ...
    const events = fixture.nativeElement.querySelectorAll('.cal-event-container');
    ...
    expect(resizeEvent).to.deep.equal({
      ...
      newEnd: moment(new Date('2018-07-29')).startOf('day').add(1, 'day').add(19, 'hours').add(30, 'minutes').toDate(),
    });
  });
  ...
  it('should control resizing time events', () => {
    ...
    expect(resizeEvent).to.deep.equal({
      ...
      event: fixture.componentInstance.events[0],
      newStart: fixture.componentInstance.events[0].start,
      newEnd: moment(fixture.componentInstance.events[0].end).add(90, 'minutes').toDate(),
    });
    expect(validateEventTimesChanged).to.have.been.calledTwice;
    expect(validateEventTimesChanged.getCall(0).args[0]).to.deep.equal({
      type: 'resize',
    ...
    expect(validateEventTimesChanged.getCall(1).args[0]).to.deep.equal({
      ...
      event: fixture.componentInstance.events[0],
      newStart: fixture.componentInstance.events[0].start,
      newEnd: moment(fixture.componentInstance.events[0].end).add(180, 'minutes').toDate(),
    });
  });
  ...
  it('should resize a time event from the end to another day on the left when using rtl', () => {
    ...
    expect(resizeEvent).to.deep.equal({
      ...
      event: fixture.componentInstance.events[0],
      newStart: fixture.componentInstance.events[0].start,
      newEnd: moment(fixture.componentInstance.events[0].end).add(1, 'day').toDate(),
    });
  });
  ...
  it('should resize a time event from the end to another day on the left', () => {
    ...
    fixture.componentInstance.events = [
      {
        start: moment(new Date('2018-07-29')).startOf('day').add(3, 'hours').toDate(),
        end: moment(new Date('2018-07-29')).startOf('day').add(1, 'day').add(19, 'hours').add(30, 'minutes').toDate(),
        title: 'foo',
        resizable: {
          afterEnd: true,
        },
    ...
    fixture.detectChanges();
    document.body.appendChild(fixture.nativeElement);
    const event: HTMLElement = fixture.nativeElement.querySelectorAll('.cal-event-container')[1];
    const dayWidth: number = event.parentElement.offsetWidth;
    const rect: ClientRect = event.getBoundingClientRect();
    const resizeHandle = event.querySelector('.cal-resize-handle-after-end');
    let resizeEvent: CalendarEventTimesChangedEvent;
    ...
    expect(resizeEvent).to.deep.equal({
      ...
      event: fixture.componentInstance.events[0],
      newStart: fixture.componentInstance.events[0].start,
      newEnd: moment(new Date('2018-07-29')).startOf('day').add(18, 'hours').toDate(),
    });
  });
  ...
  it('should resize a time event from the end to another day on the right when using rtl', () => {
    ...
    expect(resizeEvent).to.deep.equal({
      ...
      event: fixture.componentInstance.events[0],
      newStart: fixture.componentInstance.events[0].start,
      newEnd: moment(fixture.componentInstance.events[0].end).subtract(1, 'day').toDate(),
    });
  });
  ...
  it('should resize a time event from the end and not allow it to end before it starts', () => {
    ...
    expect(resizeEvent).to.deep.equal({
      ...
      event: fixture.componentInstance.events[0],
      newStart: fixture.componentInstance.events[0].start,
      newEnd: moment(fixture.componentInstance.events[0].start).add(30, 'minutes').toDate(),
    });
  });
  ...
  it('should resize a time event from the start to another day on the left', () => {
    ...
    fixture.componentInstance.events = [
      {
        start: moment(new Date('2018-07-30')).startOf('day').add(3, 'hours').toDate(),
        end: moment(new Date('2018-07-30')).startOf('day').add(18, 'hours').toDate(),
        title: 'foo',
        resizable: {
          beforeStart: true,
        },
    ...
    expect(resizeEvent).to.deep.equal({
      type: 'resize',
      event: fixture.componentInstance.events[0],
      newStart: moment(fixture.componentInstance.events[0].start).subtract(1, 'days').subtract(90, 'minutes').toDate(),
  ...
  it('should resize a time event from the start to another day on the right', () => {
    ...
    expect(resizeEvent).to.deep.equal({
      type: 'resize',
      event: fixture.componentInstance.events[0],
      newStart: moment(new Date('2018-07-30')).startOf('day').add(3, 'hours').toDate(),
      newEnd: fixture.componentInstance.events[0].end,
    });
  });
  ...
  it('should resize a time event and not allow it to start after it ends', () => {
    ...
    expect(resizeEvent).to.deep.equal({
      type: 'resize',
      event: fixture.componentInstance.events[0],
      newStart: moment(fixture.componentInstance.events[0].end).subtract(30, 'minutes').toDate(),
      newEnd: fixture.componentInstance.events[0].end,
    });
  });
  ...
  it('should drag time events to different days and columns while snapping to a grid', () => {
    ...
    fixture.componentInstance.events = [
      {
        start: moment(new Date('2018-07-29')).startOf('day').add(3, 'hours').toDate(),
        end: moment(new Date('2018-07-29')).startOf('day').add(1, 'day').add(18, 'hours').toDate(),
        title: 'foo',
        draggable: true,
      },
      {
        start: moment(new Date('2018-07-29')).startOf('day').add(3, 'days').toDate(),
        title: 'bar',
        draggable: true,
      },
    ];
    ...
    const updatedEvents = fixture.nativeElement.querySelectorAll('.cal-event-container');
    ...
    expect(dragEvent).to.deep.equal({
      ...
      newStart: moment(fixture.componentInstance.events[0].start)
        ...
        .add(30, 'minutes')
        .toDate(),
      newEnd: moment(fixture.componentInstance.events[0].end).add(1, 'day').add(1, 'hour').add(30, 'minutes').toDate(),
    });
  });
  ...
  it('should control dragging time events', () => {
    ...
    expect(dragEvent).to.deep.equal({
      ...
      allDay: false,
      event: fixture.componentInstance.events[0],
      newStart: moment(fixture.componentInstance.events[0].start).add(90, 'minutes').toDate(),
      newEnd: moment(fixture.componentInstance.events[0].end).add(90, 'minutes').toDate(),
    });
    expect(validateEventTimesChanged).to.have.been.calledTwice;
    expect(validateEventTimesChanged.getCall(0).args[0]).to.deep.equal({
    ...
    expect(validateEventTimesChanged.getCall(1).args[0]).to.deep.equal({
      type: 'drag',
      event: fixture.componentInstance.events[0],
      newStart: moment(fixture.componentInstance.events[0].start).add(180, 'minutes').toDate(),
      newEnd: moment(fixture.componentInstance.events[0].end).add(180, 'minutes').toDate(),
    });
  });
  ...
  it('should drag time events back to their original position while snapping to a grid', () => {
    ...
    const originalEvent = {
      start: moment(new Date('2018-07-29')).startOf('day').add(3, 'hours').toDate(),
      end: moment(new Date('2018-07-29')).startOf('day').add(5, 'hours').toDate(),
      title: 'foo',
      draggable: true,
    };
    ...
    fixture.detectChanges();
    const updatedEvent1 = fixture.nativeElement.querySelector('.cal-event-container');
    ...
    fixture.detectChanges();
    const updatedEvent2 = fixture.nativeElement.querySelector('.cal-event-container');
  ...
  it('should drag an all day event onto the time grid', () => {
    ...
    fixture.componentInstance.events = [
      {
        start: moment(new Date('2018-07-29')).startOf('day').add(1, 'days').add(3, 'hours').toDate(),
        end: moment(new Date('2018-07-29')).startOf('day').add(2, 'days').add(18, 'hours').toDate(),
        title: 'foo',
        draggable: true,
        allDay: true,
      },
    ...
    expect(dragEvent).to.deep.equal({
      ...
      allDay: false,
      event: fixture.componentInstance.events[0],
      newStart: moment(new Date('2018-07-29')).startOf('day').add(90, 'minutes').toDate(),
    });
  });
  ...
  it('should drag a time event onto the all day grid', () => {
    ...
    fixture.detectChanges();
    document.body.appendChild(fixture.nativeElement);
    const event = fixture.nativeElement.querySelector('.cal-time-events .cal-event-container');
    const rect: ClientRect = event.getBoundingClientRect();
    let dragEvent: CalendarEventTimesChangedEvent;
    fixture.componentInstance.eventTimesChanged.pipe(take(1)).subscribe(e => {
      dragEvent = e;
    ...
    fixture.detectChanges();
    const dayColumn = fixture.nativeElement.querySelectorAll('.cal-all-day-events .cal-day-column')[2];
    ...
    expect(dragEvent).to.deep.equal({
      ...
      allDay: true,
      event: fixture.componentInstance.events[0],
      newStart: moment(new Date('2018-07-29')).startOf('day').add(2, 'days').toDate(),
    });
  });
  ...
  it('should drag time events to different days and columns while snapping to a grid and excluding weekends', () => {
    ...
    fixture.componentInstance.events = [
      {
        start: moment(new Date('2019-03-01')).startOf('day').add(3, 'hours').toDate(),
        end: moment(new Date('2019-03-01')).startOf('day').add(18, 'hours').toDate(),
        title: 'foo',
        draggable: true,
      },
    ];
    ...
    expect(dragEvent).to.deep.equal({
      ...
      newStart: moment(fixture.componentInstance.events[0].start)
        ...
        .add(30, 'minutes')
        .toDate(),
      newEnd: moment(fixture.componentInstance.events[0].end).add(3, 'days').add(1, 'hour').add(30, 'minutes').toDate(),
    });
  });
  ...
  it('should drag time events to different days and columns when rtl is enabled', () => {
    ...
    expect(dragEvent).to.deep.equal({
      ...
      allDay: false,
      event: fixture.componentInstance.events[0],
      newStart: moment(fixture.componentInstance.events[0].start).subtract(1, 'days').toDate(),
      newEnd: moment(fixture.componentInstance.events[0].end).subtract(1, 'days').toDate(),
    });
  });
  ...
  it('should drag time events to different days and columns while snapping to a grid and excluding weekends with custom hour duration', () => {
    ...
    fixture.componentInstance.events = [
      {
        start: moment(new Date('2019-03-01')).startOf('day').add(4, 'hours').toDate(),
        end: moment(new Date('2019-03-01')).startOf('day').add(18, 'hours').toDate(),
        title: 'foo',
        draggable: true,
      },
    ...
    expect(dragEvent).to.deep.equal({
      ...
      allDay: false,
      event: fixture.componentInstance.events[0],
      newStart: moment(fixture.componentInstance.events[0].start).add(3, 'days').add(1, 'hour').toDate(),
      newEnd: moment(fixture.componentInstance.events[0].end).add(3, 'days').add(1, 'hour').toDate(),
    });
  });
  ...
  it('should preserve css classes on hour segments when dragging an event', () => {
    ...
    fixture.componentInstance.beforeViewRender.subscribe((view: CalendarWeekViewBeforeRenderEvent) => {
    ...
    fixture.componentInstance.ngOnChanges({ viewDate: {}, events: {} });
    fixture.detectChanges();
    expect(fixture.nativeElement.querySelector('.cal-hour-segment').classList.contains('disabled-cell')).to.be.true;
    document.body.appendChild(fixture.nativeElement);
    const events = fixture.nativeElement.querySelectorAll('.cal-event-container');
    const dayWidth: number = events[0].parentElement.offsetWidth;
    const rect: ClientRect = events[0].getBoundingClientRect();
  ...
  it('should resize a time event to the minimum height', () => {
    ...
    fixture.detectChanges();
    document.body.appendChild(fixture.nativeElement);
    const event: HTMLElement = fixture.nativeElement.querySelectorAll('.cal-event-container')[0];
    const rect: ClientRect = event.getBoundingClientRect();
    const resizeHandle = event.querySelector('.cal-resize-handle-after-end');
    let resizeEvent: CalendarEventTimesChangedEvent;
    fixture.componentInstance.eventTimesChanged.pipe(take(1)).subscribe(e => {
    ...
    expect(resizeEvent).to.deep.equal({
      ...
      event: fixture.componentInstance.events[0],
      newStart: fixture.componentInstance.events[0].start,
      newEnd: moment(fixture.componentInstance.events[0].start).add(1, 'minutes').toDate(),
    });
  });
  ...
  it('should resize a time event to the minimum height with custom hour duration', () => {
    ...
    fixture.componentInstance.events = [
      {
        start: moment(new Date('2018-07-29')).startOf('day').add(4, 'hours').toDate(),
        end: moment(new Date('2018-07-29')).startOf('day').add(6, 'hours').toDate(),
        title: 'foo',
        resizable: {
          afterEnd: true,
        },
  ...
  it('should allow css variables for colors', () => {
    ...
    expect(computedStyles.getPropertyValue('background-color')).to.equal('rgb(0, 0, 0)');
    expect(computedStyles.getPropertyValue('border-color')).to.equal('rgb(255, 255, 255)');
    document.head.appendChild(style);
  });
  ...
  it('should allow external events to be dropped on the hour segments', () => {
    ...
    const segments: HTMLElement[] = Array.from(
      fixture.nativeElement.querySelectorAll('.cal-day-columns .cal-hour-segment'),
    );
    ...
    expect(eventDropped).to.have.been.calledWith({
      type: 'drop',
      event: externalEventFixture.componentInstance.event,
      newStart: moment('2016-06-27').startOf('week').add(30, 'minutes').toDate(),
      allDay: false,
    });
    expect(eventDropped).to.have.been.calledOnce;
  });
  ...
  it('should update event times when dragging', () => {
    ...
    eventTitle.week = ({ start, end }: CalendarEvent) => {
      return formatDate(start, 'H:mm', 'en') + ' - ' + formatDate(end, 'H:mm', 'en');
    };
    fixture.componentInstance.viewDate = new Date('2018-07-29');
    const originalEvent = {
      start: moment(new Date('2018-07-29')).startOf('day').add(3, 'hours').toDate(),
  ...
  it('should set a minimum event height', () => {
    ...
    fixture.componentInstance.ngOnChanges({ viewDate: {}, events: {} });
    fixture.detectChanges();
    expect(fixture.nativeElement.querySelector('.cal-event-container').offsetHeight).to.equal(30);
    fixture.destroy();
  });
  ...
  it('should drag a time event down and into another day', () => {
    ...
    expect(dragEvent).to.deep.equal({
      ...
      allDay: false,
      event: fixture.componentInstance.events[0],
      newStart: moment(fixture.componentInstance.events[0].start).add(1, 'hour').add(30, 'minutes').toDate(),
      newEnd: moment(fixture.componentInstance.events[0].end).add(1, 'hour').add(30, 'minutes').toDate(),
    });
  });
